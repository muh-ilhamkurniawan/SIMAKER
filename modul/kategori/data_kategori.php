                        ...
                        <?php
                            ...
                            if ($resultkelas->num_rows>0) {
                                while ($row = $resultkelas->fetch_assoc()) {
                                    $kategori = $row['nama_kelas'];
                                    ?>
                                    <tr>
                                        <td><?php echo $row['kode_kelas'];?></td>
                                        <td><?php echo $kategori;?></td>
                                        <td><a href="././hapus.php?k=hapus_kelas&id=<?php echo $row['kode_kelas']?>" onclick="return confirm('Yakin Hapus Kategori \'<?php echo $kategori;?>\' ?')" class="btn btn-danger">Hapus</a></td>
                                    </tr><?php
                                }
                            }
                            ?>
