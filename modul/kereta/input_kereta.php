      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Tambah Kereta</h2>
              <p class="text-muted">Tambah Data Kereta Baru.</p>
                  ...
                  <div class="card-body">
                    <form method="post" action="././simpan.php?ip=input_kereta">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama KA" onkeyup="this.value = this.value.toUpperCase()" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="datang" name="datang" placeholder="tujuan" required>
                      </div>
                      <div class="form-group">
                        <label for="inputAddress">Jam Keberangkatan</label>
                        <input type="time" class="form-control" id="berangkat" name="berangkat" placeholder="tujuan" required>
                      </div>
